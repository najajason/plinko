...
$('#doBetButton').click(function() {
    ...
    $.ajax({
        ...
        data: JSON.stringify({
            ...
            hash: String(Hash),
            wager: bet,
            pay_table: [0, 5, 0, 3, 2, 1, 6, 1, 6, 1, 2, 3, 0, 5,0]
        }),
        dataType: "json"
    }).done(function(data){
        if(data.next_hash){
